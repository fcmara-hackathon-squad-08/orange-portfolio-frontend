...
MdFilledField.styles = [styles$8, styles$5];
...
MdFilledTextField.styles = [styles$6, styles$4];
...
/**
  ...
  * SPDX-License-Identifier: Apache-2.0
  */
const styles$3 = i$4 `:host{display:flex;flex-wrap:wrap;gap:8px}/*# sourceMappingURL=chip-set-styles.css.map */
`;
...
MdSuggestionChip.styles = [styles$1, styles$2, styles];
